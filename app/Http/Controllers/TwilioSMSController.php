...
class TwilioSMSController extends Controller
{
    ...
    {  // $phone = "+".str( $phone);
        ...
        $verification_number =$verification_key;// "123456" ;// Str::random(6);
           if($proccess == 1){
            $message = "Hello ".$firstName." Please verify that you own this phone number using the following code : ".$verification_key;

           }elseif($proccess == 2){
            $message = "Hello ".$firstName." Please enter this verification code to be able to change your password : ".$verification_key;
           }elseif($proccess == 3){
    ...
    public function treatment_sms($start_time,$phone  ,$name  )
    {  // $phone = "+".str( $phone);
        $receiverNumber = "+".$phone;//"+970569595453";

            $message = "\n". "مرحبا ".$name."\n"."نود تذكيرك بأن لديك موعدا غدا"."\n"."في تمام الساعة ".$start_time."\n"."نشكرك على ثقتك بنا";
    ...
    public function warning($bookings_num ,$phone  ,$name , $proccess)
    {  // $phone = "+".str( $phone);
        $receiverNumber = "+".$phone;//"+970569595453";
       // return response()->json(['message'=>  $receiverNumber]);
          $help_number= "0569457819";
       // "123456" ;// Str::random(6);
        if($proccess == 1){
            $message = "\n". "مرحبا ".$name."\n"."لقد قمت بتغير موعد فحصك  \n" .$bookings_num."\n"." مرات إن كنت بحاجة لمساعدة ما يمكنك الاتصال بالرقم التالي ".$help_number;
           }elseif($proccess == 3){
          //  $message = "\n". "مرحبا ".$name."\n"."نود تذكيرك بأن لديك موعدا غدا بتارخ".$bookings_num."\n"."في تمام الساعة ".$initial->start_time."\n"."نشكرك على ثقتك بنا";
           }
